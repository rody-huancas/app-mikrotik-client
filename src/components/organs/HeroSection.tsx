...
const HeroSection = () => {
  ...
  return (
    <section className="w-full h-auto bg-gradient-to-r from-pink-800 to-blue-500 relative overflow-x-hidden">
      <Slider
            ...
            <div className="md:w-[50%] w-full md:h-full h-1/2 absolute md:top-0 top-1/2 right-0 bg-zinc-900 flex flex-col md:justify-center justify-start lg:gap-8 md:gap-4 gap-2 lg:px-20 md:px-6 px-4 overflow-x-hidden">
              ...
              <div className="flex items-center gap-8">
                <Slide direction="up">
                  <Button
                    type="button"
                    className="px-10 font-medium text-white py-2.5 bg-indigo-600"
                  >
                    {hero.Button}
                  </Button>
                </Slide>
